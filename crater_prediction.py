...
ROOT_DIR = os.path.abspath("/home/rnemade/craters/")
# Import Mask RCNN
sys.path.append(ROOT_DIR)  # To find local version of the library
DEFAULT_LOGS_DIR = os.path.join(ROOT_DIR, "logs")
IMAGE_PATH= "/home/rnemade/craters/moon-images/tile_0_17000.png"
preds = "/home/rnemade/craters/moon-images/preds/"
COCO_WEIGHTS_PATH = os.path.join(ROOT_DIR, "mask_rcnn_coco.h5")
trained_model_path = os.path.join(ROOT_DIR, "trained_rcnn.h5")
DATASET_DIR = "/home/rnemade/craters/npy/"
...
            image_path="/home/rnemade/craters/moon-images/"+filename[:-4]
            self.add_image(
...
        #print("load mask time-", image_info["annotation_path"], time.time() - start)
...
def detect_and_color_splash(model, image_path=None, filename=None):
    # Image or video?
    if image_path:
...
#    detect_and_color_splash(model, image_path=IMAGE_PATH, None)
    testset = "/home/rnemade/craters/moon-images/"
...
      #rgb_im = im.convert('RGB')
      #IMAGE_PATH = IMAGE_PATH1[:-3] + 'jpg'
      #rgb_im.save(IMAGE_PATH)
      detect_and_color_splash(model, image_path=IMAGE_PATH, filename=filename)
